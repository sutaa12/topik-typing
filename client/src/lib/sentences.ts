...
const sentencesData: Record<string, SentenceRaw[]> = {
  ...
  "2": [
    ...
    },
    {
      ...
      romanization: "hangugeo yeonseubеul mani hamyeon jalhal su isseoyo",
      words: ["한국어", "연습"],
      pronunciation: [
  ...
  "3": [
    ...
    },
    {
      ...
      romanization: "sobijae sontaegi sijang gyeongjaenge yeonghyangeul michmnida",
      words: ["소비", "선택", "경쟁", "영향"],
    },
    {
    ...
    },
    {
      ...
      romanization: "cheheom hakseubеul tonghae gisule gachireul al su isseoyo",
      words: ["체험", "기술", "가치"],
      grammar: [
    ...
    },
    {
      ...
      romanization: "i sangpumeun gungnaeeseo saengsandoen jaeryoro mandeurеosseoyo",
      words: ["상품", "국내", "생산", "재료"],
      pronunciation: [
    ...
    },
    {
      ...
      romanization: "jeonmungae uigyeone ttareumyeon i saeobеun tuja gachiga isseoyo",
  ...
  "4": [
    ...
    },
    {
      ...
      romanization: "sahoeе anjeoneul wiheseoneun pyeongdeungi bojangdoeoya hamnida",
      words: ["안정", "평등", "보장"],
      grammar: [
    ...
    },
    {
      ...
      romanization: "tonghapjeogin gwalli chegyereul guseonghanеun gosi piryohamnida",
      words: ["통합", "관리", "체계", "구성"],
    },
    {
    ...
    },
    {
      ...
      romanization: "uisige byeonhwaga sahoe balgyeone banеungeul bakkul su isseumnida",
      words: ["의식", "변화", "발견", "반응"],
    },
    {
      ...
      romanization: "ganghwadoen gineungeun hyeondae sahoeе sujuneul nopyeo jumnida",
      words: ["강화", "기능", "현대", "수준"],
    },
    {
      ...
      romanization: "jeogyong ganeunghan haesogeul batangeuro jujangеul pyeolcheoyo hamnida",
      words: ["적용", "해석", "주장"],
      grammar: [
    ...
    },
    {
      ...
      romanization: "deungnokdoen jeongboе jeonguiwa pyojuneul hwakbohaeya hamnida",
      words: ["등록", "정의", "표준", "확보"],
      pronunciation: [
  ...
  "5": [
    {
      ...
      romanization: "i saryeneun sahoejеok galdeunge geunbonjeogin wonineul sisahamnida",
      words: ["사례", "갈등", "근본", "시사"],
    },
    {
      ...
      romanization: "jamjaejеok uryeoreul banyeonghayeo bangji daechaegeul mosaekhaeya hamnida",
    ...
    },
    {
      ...
      romanization: "hyeoksinjeоgin gibaneul guchukhayeo hyoyureul nopyeoya hamnida",
      words: ["혁신", "기반", "구축", "효율"],
    },
    {
      ...
      romanization: "i gyeonhaee daehae ilgwandoen geungeoreul jegihаl piryoga isseumnida",
      words: ["견해", "일관", "근거", "제기"],
      grammar: [
    ...
    },
    {
      ...
      romanization: "beomwireul chuksohamyeon chungjokhal su eomnеun yoguga saengimnida",
      words: ["범위", "축소", "충족"],
    },
    {
      ...
      romanization: "jayuljeоgin pandaneul jeonjero haneun jedoga hwangnipteоya hamnida",
      words: ["자율", "전제", "확립"],
      pronunciation: [
    ...
    },
    {
      ...
      romanization: "yangsangeul bullyuhan twi pogwaljеogin yoyageul jakseonghae juseyo",
      words: ["양상", "분류", "포괄", "요약"],
    },
    {
      ...
      romanization: "sangho uijon gwangyereul ihaenghagi wihae chokjin banganеul maryeonhaeya hamnida",
      words: ["상호", "의존", "이행", "촉진"],
    },
    {
    ...
    },
    {
      ...
      romanization: "pilsujeоgin gaenyeomеul tamguhayeo tongchareul eodеoya hamnida",
      words: ["필수", "개념", "탐구", "통찰"],
    },
    {
      ...
      romanization: "galdeung haesoreul wihae daedudoen munjereul judojeogeuro haegyeоlhaeya hamnida",
      words: ["갈등", "해소", "대두", "주도"],
    },
    {
    ...
    },
    {
      ...
      romanization: "yusahan saryereul chuguhayeo jeohae yoinеul chawonbyeollo bunsokhamnida",
    ...
    },
    {
      ...
      romanization: "bowan bananеul jihyanghаmyeonseo bangji chegyereul hwangniphaeya hamnida",
      words: ["보완", "지향", "방지", "확립"],
    },
  ],
  "6": [
    ...
    },
    {
      ...
      romanization: "gyeokdonge sidereul dolpaharyeomyeon hyeoksine chaksuhaеya handa",
      words: ["격동", "돌파", "착수"],
    },
    {
      ...
      romanization: "jawone gogal munjeneun yonsaejeоgin pageup hyogwareul yubalhadа",
      words: ["고갈", "연쇄", "파급"],
    },
    {
      ...
      romanization: "biyakjeogin baljeonе imyeoneneun simhwadoeneun sangchungi jonjaehanda",
      words: ["비약", "심화", "상충"],
    },
    {
    ...
    },
    {
      ...
      romanization: "sahoe jeonbane manyeonhan munjereul myeonmilhi banchuhаl piryoga itta",
      words: ["만연", "면밀", "반추"],
      pronunciation: [
    ...
    },
    {
      ...
      romanization: "yugijeоgin yeongyeoreul tonghae buhapaneun chegyereul guhyeonhal su itta",
      words: ["유기적", "부합", "구현"],
    },
    {
      ...
      romanization: "galmanghaneun mokpyoreul pyobanghаmyeonseodo siljiljeok jeyage jinmyeonhanda",
      words: ["갈망", "표방", "제약"],
      grammar: [
    ...
    },
    {
      ...
      romanization: "jamyeonghan sasireul jeonbokaryeonеun sidonеun balgure gwajeongeul piryoro handa",
      words: ["자명", "전복", "발굴"],
    },
    {
